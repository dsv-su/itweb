@include('stats.partials.unit-chart', [
    ...
    'note' => (match (request('breakdown')) {
        'unit' => 'Investigators are grouped by units. Proposals linked to multiple units appear once in each unit. ',
        ...
        ? 'Proposals sent to the funder, including those subsequently granted.'
