<label for="oh_eu" class="mt-2 font-sans block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __("DSV Premises %") }}<span class="text-red-600"> *</span>
</label>
<input type="number"
       name="oh_premises"
       ...
       placeholder="OH Premises"
       value="{{$oh->oh_premises}}">
@error('oh_premises')
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (document.querySelector('.text-red-600')) {
            ...
            document.querySelector('input[name="oh_premises"]').focus();
        }
    });
</script>
