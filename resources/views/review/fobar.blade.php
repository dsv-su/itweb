...
>
    ...
    @endif
        <div class="my-4">
            ...
            <textarea id="comment" name="comment" form="fo-review-form" rows="4"
                      ...
                      placeholder="Please comment the request">{{ old('comment') }}</textarea>
        </div>
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between gap-2 w-full">
            ...
            <button type="submit" form="fo-review-form" name="decision" value="return"
            ...
            <button type="submit" form="fo-review-form" name="decision" value="update"
