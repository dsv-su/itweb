<div class="flex flex-wrap justify-between items-center">
    <div class="flex items-center">
        ...
        <button
            ...
            class="hidden md:block p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900
        ...
        <div
            class="hidden overflow-hidden z-50 my-4 w-full md:max-w-md text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700"
        ...
        <!-- Desktop Requestforms -->
        <button
            data-tooltip-target="workflow-requests-tooltip"
            type="button"
            data-dropdown-toggle="apps-dropdown-desktop"
            data-dropdown-placement="bottom-end"
            class="hidden md:block p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100
        ...
        <div
            class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y
                   divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600"
