    ...
    <div class="md:hidden block grid grid-cols-4 border-b-4 border-susecondary">
        ...
        <div class="items-center inline-flex justify-start col-span-3 sm:flex px-5 bg-sudepartment">
            ...
            <button
                ...
                class="theme-toggle ml-auto flex items-center w-6 h-6 justify-center text-xs font-small text-white outline outline-offset-2 outline-1 rounded-sm
    ...
    <div class="hidden md:block md:grid grid-cols-4 border-b-4 border-susecondary">
        ...
        <div class="md:opacity-100 opacity-0 flex items-center justify-end col-span-1 bg-sudepartment px-2">
            ...
            <button {{--}}id="theme-toggle"{{--}}
                    ...
                    type="button" data-toggle-dark="light"
                    class="theme-toggle flex items-center w-6 h-6 justify-center text-xs font-small text-white outline outline-offset-2 outline-1 rounded-sm
                    toggle-dark-state-example hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 focus:outline-none
                    dark:text-gray-200 dark:border-gray-200 dark:hover:text-white dark:hover:bg-gray-700"
            >
