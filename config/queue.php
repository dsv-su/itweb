...
return [
    ...
    */
    ...
    'default' => $system_config['queue']['queue_connection'],
    ...
    */
    ...
    'connections' => [
        ...
        'database' => [
            'driver' => 'database',
            'connection' => $system_config['queue']['db_queue_connection'],
            'table' => $system_config['queue']['db_queue_table'],
            'queue' => $system_config['queue']['db_queue'],
            'retry_after' => (int) $system_config['queue']['db_queue_retry_after'],
            'after_commit' => false,
        ],
