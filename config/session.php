...
return [
    ...
    */
    ...
    'driver' => $system_config['session']['session_driver'],
    ...
    */
    ...
    'lifetime' => (int) $system_config['session']['session_lifetime'],

    'expire_on_close' => $system_config['session']['session_expire_on_close'],
    ...
    */
    ...
    'encrypt' => $system_config['session']['session_encrypt'],
    ...
    */
    ...
    'connection' => $system_config['session']['session_connection'],
    ...
    */
    ...
    'table' => $system_config['session']['session_table'],
    ...
    */
    ...
    'secure' => $system_config['session']['session_secure_cookie'],
    ...
    */
    ...
    'same_site' => $system_config['session']['session_same_site'],
