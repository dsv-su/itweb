...
return [
    ...
    */
    ...
    'default' => $system_config['mail']['mail_mailer'],
    ...
    */
    ...
    'mailers' => [
        ...
        'smtp' => [
            ...
            'url' => env('MAIL_URL'),
            'host' => $system_config['mail']['mail_host'],
            'port' => $system_config['mail']['mail_port'],
            'username' => $system_config['mail']['mail_username'],
            'password' => $system_config['mail']['mail_password'],
            'timeout' => null,
