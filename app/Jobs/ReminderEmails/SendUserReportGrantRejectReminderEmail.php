...
use App\Mail\Reminders\GrantOrRejectReminder;
...
class SendUserReportGrantRejectReminderEmail implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Mail::to($user->email)->send(new GrantOrRejectReminder($user, $dashboard));
    }
}
