...
use App\Mail\Reminders\SentReminder;
...
class SendUserReportSentReminderEmail implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Mail::to($user->email)->send(new SentReminder($user, $dashboard));
    }
}
