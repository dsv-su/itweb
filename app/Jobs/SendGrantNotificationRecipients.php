...
use App\Mail\GrantNotificationRecipient;
...
class SendGrantNotificationRecipients implements ShouldQueue
{
        ...
        collect($this->recipients)
            ...
            ->each(function (array $recipient) {
                Mail::to($recipient['email'])->send(
                    new GrantNotificationRecipient($this->user, $recipient, $this->dashboard)
                );
            });
    }
}
