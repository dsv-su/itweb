...
class GrantNotificationRecipients extends Component
{
    ...
    public function mount(): void
    {
        ...
        $this->recipients = $settings->grant_notification_recipients ?? [];
    ...
    public function save(): void
    {
        ...
        $settings = SettingsVice::firstOrCreate();
        $settings->grant_notification_recipients = array_values($this->recipients);
        $settings->save();

        $this->savedRecipients = array_values($this->recipients);

        session()->flash('grant_notification_recipients_saved', 'Grant notification recipients updated.');
    }
    ...
    {
        return view('livewire.pp.grant-notification-recipients');
    }
}
